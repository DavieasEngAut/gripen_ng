...
export default function GripenHUD({ onBack }: GripenProps) {

    <button 
        onClick={onBack}
        className="absolute top-4 left-4 z-50 text-cyan-500 hover:text-white transition-colors flex items-center gap-2 font-mono text-xs">
        [ ESC ] EXIT_TO_MENU
      </button>
